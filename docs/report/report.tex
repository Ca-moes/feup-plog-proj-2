...
\input{conteudo/2_descricao_do_problema}

\section{Abordagem}
\input{conteudo/3_abordagem}

\section{Visualização da Solução}
\input{conteudo/4_visualizacao_solucao}

\section{Experiências e Resultados}
\input{conteudo/5_experiencias_resultados}

\section{Conclusões e Trabalho Futuro}
\input{conteudo/6_conclusoes}

\clearpage
\appendix
\section{Tabelas de dados}
\input{conteudo/A_tabelas}
\clearpage
\section{Gráficos}
\input{conteudo/B_graficos}
\clearpage
\section{Anexos}
\input{conteudo/C_Anexos}
